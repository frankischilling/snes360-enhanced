...
//    printf("        [%10g %10g]  [%04x %04x]\n", C/4096.0, D/4096.0, C&0xffff, D&0xffff);
    ...
    XMemSet(Memory.C4RAM, 0, (w+row_padding/4)*h/2);
...
static void C4SprDisintegrate()
{
    ...
    XMemSet(Memory.C4RAM, 0, width*height/2);
...
#endif
                XMemSet(Memory.C4RAM+0x300, 0, 16*12*3*4);
                C4DrawWireFrame();
                break;
...
//                printf("2d Transform Coords!\n");
              ...
              case 0x54: // Square
...
#endif
                {
                    ...
                    //__int64 a=(__int64)(0x00ffffff & *((unsigned int *)Memory.C4RAM+0x1f80));
					//if(!((a&0x800000)==0)) a=a|0xffffffffff000000;
